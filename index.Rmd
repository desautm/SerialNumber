...
colnames(alldata)[6] <- "Configuration date"
# proddata <- tesla %>%
...
date <- as.Date(c('2018-03-24','2018-03-31','2018-04-07','2018-04-14','2018-04-16','2018-06-23','2018-06-30'))
total <- c(10431,12451,14521,16771,17201,35998,41029)
