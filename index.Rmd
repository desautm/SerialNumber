...
TODO: HYPOTHÈSES SUR LES NUMÉROS DE SÉRIES DES CHARS...
...
TODO: ON FAIT LE CALCUL AVEC LES NOMBRES PIGÉS...
...
Les VINs des usagers, la NHSTA et la production exacte de Tesla.
...
Les VINs des usagers, la NHSTA, la production exacte de Tesla et $N_4$.
...
Les VINs des usagers, la NHSTA, la production exacte de Tesla et $N_5$.
...
g <- ggplot()+
  geom_point(data = INVITES, mapping = aes(x = date, y = vin_invites), 
             ...
             size = 2,
             color = "blue")+
  geom_line(data = INVITES, mapping = aes(x = date, y = N5), 
            color = "yellow",
            size = 2)+
  #geom_line(data = INVITES, mapping = aes(x = date, y = N5), color = "yellow")+
  geom_line(data = PRODUCTION, mapping = aes(x = date, y = total_unites), 
